        ...
        return (
            (this.props.numSelected > 0) ?
                <div className="update-applicants-container">
                    <div className="update-applicants-card">
                        <p id="num-applicants-selected">{this.props.numSelected} {numSelectedText}</p>
                        <div>
                            <p className="update-applicant-account-status">Update their recruitment status</p>
                            <div className="row">
                                <div className="column"><RadioButton label="Active" updateApplicants={this.props.updateApplicants} /></div>
                                <div className="column"><RadioButton label="Released" updateApplicants={this.props.updateApplicants} /></div>
                            </div>
                        </div>
                        ...
                        >Delete {this.props.numSelected} applicants</ButtonLink>
                    </div>
                </div> : null
        )
    }
