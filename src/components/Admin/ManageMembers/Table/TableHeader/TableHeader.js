        ...
        return (
            <thead id="member-table-header-grid-container">
                <tr id="member-table-header-row-grid-container">
                    ...
                    <th id="member-header" className="name-header-click-area" onClick={event => this.props.handleSort(event)}>
                    ...
                    <th id="member-header" className="email-header-click-area" onClick={event => this.props.handleSort(event)}>
                    ...
                    <th id="member-header" className="comments-header-click-area" onClick={event => this.props.handleSort(event)}>
                    ...
                    <th id="member-header" className="admin-header-click-area" onClick={event => this.props.handleSort(event)}>
