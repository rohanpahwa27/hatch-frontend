...
class UpdateTagsCard extends Component {
  render() {
    ...
    // const numSelectedText = (this.props.numSelected > 1) ? "tags selected" : "applicant selected";
    // const applicantButtonText = (this.props.numSelected == 1) ? "Go to applicant profile" : "";
    // const deleteApplicantText = (this.props.numSelected > 1) ? `Delete ${this.props.numSelected} tags` : "Delete this applicant";

    return (
      <div id="update-tags-container">
        <div id="update-tags-card">
          hello
                        {/* <p id="num-tags-selected">{this.props.numSelected} {numSelectedText}</p>
                        <div>
                        ...
                        <div id="card-bottom-space">
                            ...
                            {(this.props.numSelected == 1) ?
                                (<button
                                    id="manage-tags-goto-profile-button"
